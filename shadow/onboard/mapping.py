...
HINTS: dict[str, list[str]] = {
    "date": ["date", "transaction date", "value date", "posting date", "txn date", "booked",
             "invoice date", "document date", "statement date", "trans date"],
    "posted_at": ["posted at", "posted date", "entered", "created", "entry date", "posted on"],
    "amount": ["amount", "value", "net", "transaction amount", "gross", "total", "amt",
    ...
    "id": ["id", "code", "user id", "employee id", "email", "invoice no", "invoice number",
           "invoice id", "number", "record id"],
    "name": ["name", "full name", "person", "description", "account name",
             "account description"],
    "role": ["role", "title", "job title", "position"],
    "senior": ["senior", "approver", "is senior", "can approve"],
    "party": ["party", "customer", "vendor", "supplier", "name", "customer name",
